...
/* 02/21/2004 Wendell Buckner
    DOT3 BUMPMAPPING */
GENESISAPI geBoolean GENESISCC geBitmap_GetEngineSupport(void * EngineSupport, Guint32 DesiredEngineSupport );
...
GENESISAPI void GENESISCC geBitmap_SetRenderFlags(const geBitmap *Bmp, Guint32 *Flags);
