...
GENESISAPI Gint32 GENESISCC geBody_GetBoneNameChecksum(const geBody *B);
...
GENESISAPI void GENESISCC geBody_SetVertexColorDot3( geVec3d LightPosition, const geXForm3d *Mdl2WldXFA, const geBody *B, Gint16 VertexIndex, geFloat *ColorDot3, Gint16 LightType, geBoolean *Reset );
