...
// *************************************************************************
// *	  	Start_New_Project_V2:- Terry and Hazel Flanigan 2024		   *
// *************************************************************************
void SB_Project_Create::Start_New_Project_V2()
{
...
bool SB_Project_Create::Create_New_Area()
{
	...
	App->m_pDoc->SetTitle(App->CL_World->mCurrent_3DT_PathAndFile);
	App->m_pDoc->SetPathName(App->CL_World->mCurrent_3DT_PathAndFile, FALSE);
...
// *************************************************************************
// *	  		Load_Project_V2:- Terry and Hazel Flanigan 2024			   *
// *************************************************************************
bool SB_Project_Create::Load_Project_V2()
{
